...
class HealthChecker():
    def __init__(self, health_check_interval: int, health_check_timeout: int, controller_id: int, num_of_healthcheckers: int):
        self.health_check_interval = health_check_interval
        self.health_check_timeout = health_check_timeout
        self.controller_name = f"health_checker_{controller_id}"
